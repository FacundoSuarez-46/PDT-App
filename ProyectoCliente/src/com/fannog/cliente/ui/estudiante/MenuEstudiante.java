...
public class MenuEstudiante extends javax.swing.JFrame {
    ...
    private void init() {
        sidebar.addTitle("SOLICITUDES");
        sidebar.addMenuItem(new SidebarItemModel("Solicitudes"));
    ...
    private void handleSidebarSelection(int index, int indexSubMenu) {
        switch (index) {
            case 0 -> {
                showForm(new ListadoSolicitudes());
            }
            case 1 -> {
    ...
    private void initComponents() {
        ...
        setTitle("Fannog - Menu Estudiante");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(sidebar, javax.swing.GroupLayout.PREFERRED_SIZE, 312, javax.swing.GroupLayout.PREFERRED_SIZE)
